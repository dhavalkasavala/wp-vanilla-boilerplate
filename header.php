		...
		<nav class="flex items-center justify-between flex-wrap bg-teal p-6">
			  ...
			  <div class="block lg:hidden">
				<button class="flex items-center px-3 py-2 border rounded text-teal-lighter border-teal-light hover:text-white hover:border-white menuToggle">
				  <svg class="h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title><?php _e('Menu','wp-vanilla'); ?></title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
				</button>
			  </div>
