...
function twentynineteen_scripts() {
	...
	wp_enqueue_style('wp-vanilla-main-style',get_template_directory_uri().'/assets/sass/app.css');
	...
	wp_enqueue_style('wp-vanilla-main-js',get_template_directory_uri().'/assets/js/app.js');	
